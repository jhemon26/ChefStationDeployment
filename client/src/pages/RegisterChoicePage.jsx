  ...
  return (
    <div className="auth-page">
      <div className="auth-box">
        <div className="lock-icon blue"><svg><use href="#ico-users" /></svg></div>
        ...
        <Link className="card" to="/register/restaurant" style={{ display: 'block', cursor: 'pointer', marginBottom: 12, borderColor: 'var(--blue-dim)' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
            <div className="lock-icon blue" style={{ margin: 0, width: 40, height: 40, flexShrink: 0 }}><svg style={{ width: 20, height: 20 }}><use href="#ico-building" /></svg></div>
            <div>
        ...
        <Link className="card" to="/register/staff" style={{ display: 'block', cursor: 'pointer', borderColor: 'var(--green-dim)' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
            <div className="lock-icon green" style={{ margin: 0, width: 40, height: 40, flexShrink: 0 }}><svg style={{ width: 20, height: 20 }}><use href="#ico-key" /></svg></div>
            <div>
